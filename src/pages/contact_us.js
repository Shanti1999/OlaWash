...
export default function Contact_Us() {
  ...
  <div className="nav-container">
    ...
    <nav>
     ...
     <div className='row' id='contact_Us'>
      <div className="context">
      <p>CONTACT OF OLA CAR WASH</p>
        <h1>WE READY TO SHINE</h1>
        <h2>
        WE ARE AVAILABLE
        </h2>
...
<section>
    ...
    <div className='columns'>
        <img src="assets/img/card.png" alt="about_img" className='img_about'/></div>
		<div className='column'>
        
            <div className="form-wrapper">
            <div className='one'>	<h1>Contact Us</h1>
           </div>
           <p className='text pt-5'>Ola Car Wash Customer Service is always available to help. You can submit enquiry form or email us or call us regarding your queries, so that we can serve you better in future.</p>
    		<div className="form-inner-wrapper">
    		    <form id="contactForm" method="post" >	
    			<div className="field-list clear">
                <div id="name" className="form-item field email required">
	                  			<label className="title_heading" htmlFor="Name">Name<span className="required">*</span></label>
	                  			<input className="field-element" name="name" placeholder="Name" x-autocompletetype="name"  type="tel" spellCheck="false" required/>
	                		</div>
    					<div id="email" className="form-item field mobile_number required">
	                  			<label className="title_heading" htmlFor="mobile_number">Mobile Number<span className="required">*</span></label>
	                  			<input className="field-element" name="mobile_number" placeholder="Mobile Number" x-autocompletetype="name"  type="tel" spellCheck="false" required/>
	                		</div>

			                <div id="pass" className="form-item field email required">
				                <label className="title_heading" htmlFor="email">Email<span className="required">*</span></label>
				                <input className="field-element"  x-autocompletetype="email"  placeholder="Email" type="email" id="pass" name="password"
           minlength="8"  required/>
            ...
            <div className="form-button-wrapper form-button-wrapper--align-center">
					          ...
					          <input className="button btt" type="submit" name="submit" value="Forget Password" />
					   </div>
    			</div>
    			</form>
    		</div>
