...
<section>
    <div className='row'>
    <div id="section3">
  <Link to="#" id="contact" className="js--wp-3" name="contact"></Link>
    <div className="row">
    	<div className="form-wrapper">
            <div className='one'>	<h1>Member Area</h1></div>
    	
    		<div className="form-inner-wrapper">
    		    <form id="contactForm" method="post" >	
    			<div className="field-list clear">
    					<div id="name" className="form-item field mobile_number required">
			                ...
			                <div id="pass" className="form-item field email required">
				                <label className="title_heading" htmlFor="password">Password <span className="required">*</span></label>
				                <input className="field-element"  x-autocompletetype="email"  placeholder="Password" type="password" id="pass" name="password"
           minlength="8"  required/><i class="far fa-eye" id="togglePassword" ></i>
			                </div>
