    ...
    <div id="ns-slider">
      ...
      backgroundRepeat: "no-repeat"
                    ...
                    <div className="ns-slider-text-area">
                        ...
                        <div className='butt'>
                        <Link to="./Search#choose" className="button3">Book A Wash  <i aria-hidden className="fa fa-arrow-circle-right" ></i></Link>&nbsp;
      ...
      backgroundRepeat: "no-repeat"
                    ...
                    <div className="ns-slider-text-area">
                        ...
                        <div className='butt'>
                        <Link to="./Search#choose#choose" className="button3">Book A Wash  <i aria-hidden className="fa fa-arrow-circle-right" ></i></Link>&nbsp;
                        <Link to="something" className="button3">Become A Partner <i aria-hidden className="fa fa-arrow-circle-right" ></i></Link>
                   </div>
                    </div>
                </div>
        ...
        <div className="row">
            ...
            <div className="column">
                <div className="one_1">
                    ...
                    <Link to="./Search#choose" className="button4">Book A Wash  <i className="fa fa-arrow-right" aria-hidden="true"></i></Link>
                </div>
            ...
            <div className="row">                
                ...
                <div className="image-column column">
                    <div className="inner-column wow fadeInLeft">
                        <img src='assets\img\background_image/details.png' alt="bannerimg" className='img-fluid detailing_image'></img>
                    </div>
                </div>
            </div>
        ...
        <div className="row">
                <div className="banner_div">
                    <div className="cta_paragraph">
                        ...
                        <p style={{ fontWeight:'700',color:'#fff' , fontSize:'30px' }}>Unless You Start Today!</p>
                        <p style={{ fontWeight:'700',color:'#fff' ,fontSize:'30px' }}> <span className="success">Hurry To become a</span> Service Partner</p>
                    </div>
