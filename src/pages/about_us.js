...
<section>
    ...
    <div className='column'>
        <img src="assets/img/car/car2.png" alt="about_img" className='img_about'/></div>
		<div className='column'>
            <div className='one who'>	<h1>Who We Are</h1></div>
		<div className='text'><p>Ola Car Wash™ is the most popular name in the car cleaning and detailing segment. We have to cater car care services across the country through our service partners or local verified service providers. We are acting as B2B (Business to Business) for service providers and B2C (Business to Customers) for customers simultaneously, so that a customer can easily connect to the nearest service provider.</p>
			<p>Day by day vehicles are increasing rapidly, but there is no adequate plan for cleaning such a large number of vehicles; our philosophy is to use hi-tech car care machinery so as to minimize wastage of water to meet the cleaning requirement of the vehicles and at the same time save precious water.</p>
    ...
    <div className='row'>
        <div className='text'> <p>We are encouraging everyone to save water and save lives. Generally, in the major cities of our country, a lot of water is wasted in the process of cleaning the vehicles. We are trying to change this trend by promoting the concept of Steam Car Wash; steam wash requires only 5 to 10 liters of water to completely clean the car; It is also eco-friendly and conserves water.</p>
           <p>We also offer the sanitization module which is the world's leading weapon against the spread of Antimicrobial Resistance (AMR). It kills all types of mites, mold, allergens, viruses and bacteria. We have also expanded our doorstep disinfection service to reduce the spread of various infectious diseases.</p>
           <p>Ola Car Wash started its business in 2016 with its pilot project to gather customers feedback in the Delhi region; on receiving a large number of positive responses from the customers, thereafter, in the year of 2018 it becomes an independent entity of the company registered under Ministry of Corporate Affairs, Government of India vide Registration No: 336688 (ROC Delhi); CIN: U74999DL2018PTC336688; Tan: DELO06707B; PAN: AACCO7478B; GSTIN: 07AACCO7478B1ZE</p></div>
